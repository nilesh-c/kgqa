...
from kgqa.src.data.dictionary import Dictionary, BOS_WORD, EOS_WORD, PAD_WORD, UNK_WORD, MASK_WORD
from kgqa.src.utils import AttrDict
...
class SemparseSeq2SeqTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('xlmr-model-dict', metavar='FILE',
    ...
    def setup_task(cls, args, **kwargs):
        ...
        input_vocab = Dictionary(reloaded['dico_id2word'], reloaded['dico_word2id'], reloaded['dico_counts'])
